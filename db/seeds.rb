...
b11 = Book.create(title: "Jane Eyre", author: "Charlotte Brontë", description: "Jane, an orphan, is employed as a governess, and becomes romantically involved with her employer, the mysterious and moody Edward Rochester. Jane is noted for her dependability, strong mindedness and individualism.", publisher: "Harper & Brothers", weeks_on_list: 47, rank_this_week: 11)
...
Review.create(comment: "This is my favorite book from my teenage years. I read it few times and every time is like first. Recomended.", author: "Marie B.", book_id: b11.id)
